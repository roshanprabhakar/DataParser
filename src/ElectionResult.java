public class ElectionResult {
    ...
    public ElectionResult(int votes_dem, int votes_gop, int total_votes, double per_dem, double per_gop, String diff, double perPointDiff, String state, String county_name, int combined_fips) {
        this.votes_dem = votes_dem;
        this.votes_gop = votes_gop;
        this.total_votes = total_votes;
        this.per_dem = per_dem;
    ...
    public String toString() {
        return votes_dem + "," + votes_gop + "," + total_votes + "," + per_dem + "," + per_gop + "," + diff + "," + perPointDiff + "," + state + "," + county_name + "," + combined_fips;
    }
